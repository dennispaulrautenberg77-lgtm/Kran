...
async def back_shop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not data["products"]:
        await query.edit_message_text(header + "🚫 Aktuell keine Produkte verfügbar.", parse_mode="Markdown")
        return
    ...
    await query.edit_message_text(header + "Wähle ein Produkt:", reply_markup=InlineKeyboardMarkup(keyboard), parse_mode="Markdown")
